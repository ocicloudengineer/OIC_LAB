...
module "tf-oci-module-instance-prd-labdroic-agent-000" {
  ...
  instance_number                              = "1"
  network_compartment_name                     = "ORA_TCE_OIC_ALT_LAB_DR_NET"
  ...
  image_id                                     = { us-phoenix-1 = "ocid1.image.oc1.phx.aaaaaaaajnmlrissxtk5ssava7b7wsbhr27bfs2e4jr7we4vlzvkm6oc45nq" }
